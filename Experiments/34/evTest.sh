...
#SBATCH --job-name="MAMeEx34_test"

#SBATCH --qos=training

#SBATCH --output=/home/nct01/nct01036/AutoLab2/Experiments/34/MAMeEvTest_%j.out

#SBATCH --error=/home/nct01/nct01036/AutoLab2/Experiments/34/MAMeEvTest_%j.err
