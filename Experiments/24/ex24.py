...
x = Dense(1024, activation="relu", kernel_regularizer= regularizers.L2(l2=0.01))(x)
x = Dropout(0.5)(x)
# x = BatchNormalization()(x)
x = Dense(512, activation="relu", kernel_regularizer= regularizers.L2(l2=0.01))(x)
x = Dropout(0.4)(x)
# x = BatchNormalization()(x)
x = Dense(256, activation="relu", kernel_regularizer= regularizers.L2(l2=0.01))(x)
x = Dropout(0.3)(x)
# x = BatchNormalization()(x)
